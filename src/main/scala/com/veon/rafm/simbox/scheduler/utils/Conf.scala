...
import com.veon.rafm.simbox.scheduler.utils.ClientConf.ConfEntry
...
/**
  ...
  */
class Conf(loadDefaults: Boolean) extends ClientConf[Conf](null) {
  ...
  def loadFromFile(name: String): Conf = {
    getConfigFile(name)
  ...
  private def configToSeq(entry: Conf.Entry): Seq[String] = {
